...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2018 at 08:47 AM
...
INSERT INTO `personalinfo` (`personalId`, `user_id`, `firstName`, `lastName`, `middleName`, `suffix`, `address`, `telephoneNumber`, `email`, `created`, `modified`, `mobileNumber`) VALUES
(1, 1, 'Juan', 'Dela Cruz', 'Carlos', NULL, 'new', NULL, 'juandelacruz@gmail.com', '2018-11-29 00:21:37', NULL, ''),
(2, 2, 'Maria', 'Makiling', 'Gretta', NULL, 'Petersville, Subdivision, Camp7', NULL, 'mariamakiling@gmail.com', '2018-11-29 00:31:11', NULL, ''),
(3, 3, 'Fernando', 'Delfino', 'Carpio', NULL, 'Tuding, Itogon', NULL, 'fernando@gmail.com', '2018-11-29 00:35:49', NULL, ''),
(4, 4, 'Sarah', 'Cruz', 'Reyes', NULL, 'La Trinindad, Benguet', NULL, 'sarahcruz@gmail.com', '2018-11-29 00:45:21', NULL, ''),
(5, 5, 'John', 'Bautista', 'Ocampo', NULL, 'Binalonan, Pangasinan', NULL, 'johnbautista@gmail.com', '2018-11-29 00:48:02', NULL, ''),
(6, 6, 'Mary Joy', 'Torres', 'Mendoza', NULL, 'Aurora Hill, Baguio City', NULL, 'maryjoy@gmail.com', '2018-11-29 00:50:41', NULL, ''),
(7, 7, 'admin', 'admin', 'admin', 'admin', 'admn', '0749999999', 'admin@admin.com', '2018-12-07 14:53:43', NULL, '09088899999');
...
INSERT INTO `users` (`id`, `username`, `password`, `created`, `modified`, `status`, `type`) VALUES
(1, 'juandelacruz', '$2y$10$vQSkGWamLeqBQaZT.GUNSOdZqXdFCJ4XDVYrjBB0P8QE6gA1EQc8K', '2018-11-29 00:21:37', NULL, 'Active', 'client'),
...
(7, 'admin', '$2y$10$S9WHPCYnhpeqcOJCZm4X2OseUWzNIslxhwpZz2dpZvODZvAnZsjri', '2018-12-07 14:54:05', NULL, 'Active', 'admin');
