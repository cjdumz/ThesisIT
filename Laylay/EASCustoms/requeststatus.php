...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="panel panel-default" id="headings">
      ...
      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#approverescheduleModal<?= $appointmentpending['id']; ?>"> <i class="far fa-calendar-check"></i> Approve Date</button>
      ...
      <div class="form-group">
      <div class="pull-right">
      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cancelrescheduleModal<?= $appointmentpending['id']; ?>"> <i class="far fa-calendar-times"></i> Cancel Date</button>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="date" class="form-control" name="desiredDate" id="datepicker">
      ...
      <div id="cancelrescheduleModal<?= $appointmentpending['id']; ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-times-circle"></i> Cancel Request</button>
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</button>
            </div>
          </div>
        </div>
      ...
      <div id="acceptedcheduleModal<?= $appointmentaccepted['id']; ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                <label for="created">Date Accepted:</label><br>
                <?= date("F d, Y h:i A",strtotime($appointmentaccepted['created'])); ?>   
               <label for="otherServices">Other Services:</label><br>
