...
<div class="wrapper">
    ...
    <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Reports">
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Client Request</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Appointment Request</h4>
                                <p class="category">List of Appointment Request</p>
                            </div>
