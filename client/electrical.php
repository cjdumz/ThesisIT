...
$sql2 = "SELECT serviceId,serviceType,serviceName from services where serviceType = 'Electrical'";
							...
							<br>
								<div class ="services">
									<ul>
										...
										<li><a class="active" href="electrical.php">Electrical</a></li>
								...
								<div class ="service-detail">
									...
									<input type="radio" name="service" value="<?= $service['serviceId']; ?>"><?= $service['serviceName']; ?>
									<br></input>
									<?php endforeach; ?>
									<br
