...
$sql2 = "SELECT serviceId,serviceType,serviceName from services where serviceType = 'Mechanical'";
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
							...
							<br>
								...
								<div class ="service-detail">
									...
									<?php endforeach; ?>
									<br>
									<textarea class="form-control" rows="4" id="otherService" name="otherService" placeholder="Others"></textarea>
								</div>                   
							</div>
							...
							<div class="col-md-12 col-sm-12">
								...
								<textarea class="form-control" rows="5" id="additionalMessage" name="additionalMessage" placeholder="Message"></textarea>
							</div>
