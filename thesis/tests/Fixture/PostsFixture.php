...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'user_id' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'user_id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'post_id' => 1,
                'user_id' => 1,
                'created' => '2018-08-28 05:58:15',
                'modified' => '2018-08-28 05:58:15'
            ],
        ];
        parent::init();
    }
