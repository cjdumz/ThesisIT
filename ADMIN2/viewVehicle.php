                    ...
                    <table class="table table-borderless table-dark" id="doctables2">
                      <thead>
                        <tr class="text-center">
                          ...
                          <th>Status</th>
                          <th>Progress</th>
                          <th>Action <?php echo $vehicleID ?></th>
                        </tr>
                      </thead>
                      ...
                      <?php
                            $data = $connection->prepare("SELECT appointments.id as 'ID', appointments.date as 'date', concat(firstName, ' ', middleName, ' ', lastName)
                             as 'Name', appointments.status as 'stat', targetEndDate from appointments inner join personalinfo on appointments.personalId = personalinfo.personalId
